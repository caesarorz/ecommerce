...
from categories.models import CategoryProducts
...
class Product(models.Model):
    title = models.CharField(max_length=120, help_text="Digite el nombre del producto")
    slug = models.SlugField(blank=True, unique=True)
    category = models.ManyToManyField(CategoryProducts)
